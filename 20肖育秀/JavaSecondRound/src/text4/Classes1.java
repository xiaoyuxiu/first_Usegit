...
public class Classes1 {
	...
	public Classes1(String grade,String major,String id){ //定义有参的构造方法1
		this.grade = grade;//明确访问成员变量grade 
		this.major = major;//明确访问成员变量major
		this.id = id;//明确访问成员变量id
	}
	
	public  Classes1(String grade,String major,String id,String manager){ //定义有参的构造方法2
		this.grade = grade;//明确访问成员变量grade
		this.major = major;//明确访问成员变量major
		this.id = id;//明确访问成员变量id
	...
	public static void main(String[] args){
		Classes1 class_1 = new Classes1("1班","2020级","软件工程","张强");
		Classes1 class_2 = new Classes1("2班","2020级","软件工程");
		class_1.method1();
		System.out.println();
		class_2.method1();
	}
